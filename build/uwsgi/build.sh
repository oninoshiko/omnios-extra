...
build() {
  ...
  UWSGICONFIG_PHPDIR=/opt/ooce/php-7.3/bin/php-config ./uwsgi --build-plugin "plugins/php php73" nolang || logerr "Build plugin failed: php73"
  UWSGICONFIG_PHPDIR=/opt/ooce/php-7.4/bin/php-config ./uwsgi --build-plugin "plugins/php php74" nolang || logerr "Build plugin failed: php74"
  UWSGICONFIG_PHPDIR=/opt/ooce/php-8.0/bin/php-config ./uwsgi --build-plugin "plugins/php php80" nolang || logerr "Build plugin failed: php80"
  UWSGICONFIG_PHPDIR=/opt/ooce/php-8.1/bin/php-config ./uwsgi --build-plugin "plugins/php php81" nolang || logerr "Build plugin failed: php81"
